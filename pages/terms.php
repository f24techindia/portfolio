    ...
    <section class="py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="prose prose-lg max-w-none">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-6">3. User Responsibilities</h2>
                <p class="text-gray-600 mb-6">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-6">4. Intellectual Property</h2>
                <p class="text-gray-600 mb-6">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-6">5. Limitation of Liability</h2>
                <p class="text-gray-600 mb-6">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-6">6. Contact Information</h2>
                <p class="text-gray-600 mb-4">
                    For questions about these terms of service, please contact us:
                </p>
                <div class="bg-gray-50 p-6 rounded-lg">
                    <p class="text-gray-600 mb-2"><strong>Email:</strong> legal@f24tech.com</p>
                    <p class="text-gray-600 mb-2"><strong>Phone:</strong> +1 (555) 123-4567</p>
                    <p class="text-gray-600"><strong>Address:</strong> 123 Tech Street, Silicon Valley, CA 94000</p>
                </div>
            </div>
        </div>
    </section>
